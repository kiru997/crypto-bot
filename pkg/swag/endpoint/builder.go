...
func parameter(p swagger2.Parameter) Option {
	return func(b *Builder) {
		if b.Endpoint.Parameters == nil {
			b.Endpoint.Parameters = []swagger2.Parameter{}
		}
...
func Deprecated(b bool) Option {
	return func(builder *Builder) {
		builder.Endpoint.Deprecated = b
	}
}
...
func Security(scheme string, scopes ...string) Option {
	return func(b *Builder) {
		if b.Endpoint.Security == nil {
			b.Endpoint.Security = &swagger2.SecurityRequirement{}
		}
...
func NoSecurity() Option {
	return func(b *Builder) {
		b.Endpoint.Security = &swagger2.SecurityRequirement{DisableSecurity: true}
	}
}

// ResponseOption allows for additional configurations on responses like header information
type ResponseOption func(response *swagger2.Response)

// Apply improves the readability of applied options
func (o ResponseOption) Apply(response *swagger2.Response) {
	o(response)
}

// Header adds header definitions to swagger responses
func Header(name, typ, format, description string) ResponseOption {
	return func(response *swagger2.Response) {
		if response.Headers == nil {
			response.Headers = map[string]swagger2.Header{}
		}

		response.Headers[name] = swagger2.Header{
			Type:        typ,
			Format:      format,
			Description: description,
		}
...
func ResponseType(code int, t reflect.Type, description string, opts ...ResponseOption) Option {
	return func(b *Builder) {
		if b.Endpoint.Responses == nil {
			b.Endpoint.Responses = map[string]swagger2.Response{}
		}
...
func New(method, path, summary string, options ...Option) *swagger2.Endpoint {
