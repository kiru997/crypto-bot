...
func Endpoints(endpoints ...*swagger2.Endpoint) Option {
	return func(builder *Builder) {
...
func SecurityScheme(name string, options ...swagger2.SecuritySchemeOption) Option {
	return func(builder *Builder) {
		if builder.API.SecurityDefinitions == nil {
			builder.API.SecurityDefinitions = map[string]swagger2.SecurityScheme{}
		}
...
func Security(scheme string, scopes ...string) Option {
	return func(b *Builder) {
		if b.API.Security == nil {
			b.API.Security = &swagger2.SecurityRequirement{}
		}
...
func New(options ...Option) *swagger2.API {
	b := &Builder{
		API: &swagger2.API{
			BasePath: "/",
			Swagger:  "2.0",
