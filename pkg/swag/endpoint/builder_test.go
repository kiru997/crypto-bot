...
func TestSecurityScheme(t *testing.T) {
	api := swag.New(
		swag.SecurityScheme("basic", swagger2.BasicSecurity()),
		swag.SecurityScheme("apikey", swagger2.APIKeySecurity("Authorization", "header")),
	)
